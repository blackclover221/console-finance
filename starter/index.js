...
for (var i = 0; i < finances.length; i++) {
  for (var index2 = 0; index2 < finances[i].length; index2++) {
    console.log(index2)
    if (typeof finances[i][index2] !== 'string') {
      total += finances[i][index2];
      change = finances[i][index2] - net;
      net = finances[i][index2];
